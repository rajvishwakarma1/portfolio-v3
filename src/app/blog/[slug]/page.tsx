...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    ...
    openGraph: {
      ...
      publishedTime,
      type: "article",
      url: `https://rajvishwakarma.dev/blog/${post.slug}`,
      images: [
        {
          url: `https://rajvishwakarma.dev/og/blog?title=${post.metadata.title}`,
        },
      ],
    },
    twitter: {
      ...
      creator: "@303zion",
      images: [
        `https://rajvishwakarma.dev/og/blog?title=${post.metadata.title}&top=${publishedTime}`,
      ],
    },
  }
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: post.metadata.description,
            image: `https://rajvishwakarma.dev/og/blog?title=${post.metadata.title
